...
| Acquisition/readiness and hosted-runner identity | ACTIVE PR | #1717 `c8621e9f95cc76f26810b0177d6e56e9a1428698` | The 2026-09-02 non-force two-parent reconciliation contains protected `main@b5a3a0c...` and preserves the branch delta; fresh exact-head checks/reviews are required after the restack. |
