...
| TEPP temporal boundary | ACTIVE PR | #1716 `f2dcf79b6e903c6a3edb5271ef1861bfcc4da3f8` | Context Map/ADR/PRD/TRD agree that TEPP owns temporal/event composition while fast-mlsirm owns reusable numerical kernels only; no unversioned runtime coupling. |
| Buyer/acquisition execution and CI runner identity | ACTIVE PR | #1717 `9500629c70ca8e5f5e0ed3ef246630534328d73e` | Generic acquisition workflow remains price-neutral; exact-head hosted checks complete; no repository source claim is inferred from organization runner backlog. |
...
| Interaction-map stack | ACTIVE PR | #1417 `25b9f9908a2d60782412900e932ba50000760448`, child #1457 `94699c5baa2b734ec38ef49d07f0576efd191883`, maintenance #1725 | Parent/child ancestry must be exact; Rust remains sole owner of reconstruction/explained-share arithmetic and input/result provenance. Stale child evidence must not be transferred. |
