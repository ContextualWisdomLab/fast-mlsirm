...
| [#1070](https://github.com/ContextualWisdomLab/fast-mlsirm/pull/1070) | `ce188a2ab882e333400c6c3018183837799f7ae1` | isolates NumPy parity behind explicit `fit_reference`/CLI reference surfaces | open Draft; reconcile with #951 and #626 without creating two backend authorities |
