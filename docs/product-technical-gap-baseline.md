...
Fresh GitHub inventory at this observation records **51 open pull requests** and **198 open issues**. Those counts are volatile and must be re-read before later decisions.
