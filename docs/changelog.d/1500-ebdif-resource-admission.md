...
- Replay the Rust-owned prior-variance output domain before public marshalling: the floored `tau2` must be non-negative, while finite negative `tau2_raw` remains valid as the documented pre-floor diagnostic.
