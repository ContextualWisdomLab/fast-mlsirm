...
- Added fail-closed provenance, duplicate-cell, observed-support, category-identification, dense-allocation, and task-rater connectedness gates. Sparse pilot designs may be assembled and audited after at least two categories are observed among scored records, but every declared category must be observed among scored records before the handoff delegates to the Rust estimator. Abstained, failed, excluded, and absent cells remain missing and never satisfy category coverage or become low scores.
