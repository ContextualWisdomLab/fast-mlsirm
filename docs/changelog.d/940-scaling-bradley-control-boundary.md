...
- `max_iter` is bounded by the package-wide `MAX_MAX_ITER` resource ceiling. Bradley-Terry MM arithmetic, convergence, normalization, estimates, and result statistics remain Rust-owned.
