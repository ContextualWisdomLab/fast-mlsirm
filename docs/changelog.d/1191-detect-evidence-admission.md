...
- Bound compressed shared-DAG list/tuple expansion before NumPy materialization and memoize already-validated subtrees, preventing exponentially repeated preflight work or hidden expansion beyond 20,000,000 logical cells while retaining ordinary shared-row compatibility.
