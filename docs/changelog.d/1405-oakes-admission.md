...
- Seal optional observation masks before Boolean coercion so caller truth-value protocols cannot alter which response cells enter uncertainty estimation.
