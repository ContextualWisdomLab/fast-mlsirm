...
### Exact integrated-head follow-up at `70e3466c`

A selected-path Git archive from `70e3466ca139d5880f985209785ffc503bd739b9` embeds that commit ID and has SHA256 `6dd9612a61040c84e2c05a748c212934ea9ee309ee1aa608baab4fa4521c371c`. An isolated s1 build from those tracked build inputs produced the cp312 manylinux_2_17 wheel SHA256 `5857e018cf4040e583f822786d520b6ed87322f23d3df37f16c8ed994627f0d6`. Installed-wheel regression: 10/10; all six `METADATA License-File` entries match the exact source bytes and wheel `RECORD`; embedded SBOM SHA256 `00f486568b3b9ef17f81e9990ddf445de39ae3f11bae75fafdb45bddba53dcce`.

The new s1 command is `runs/fmls-a3-integrated-70e3466c-20260926/run.sh` (SHA256 `adfe5f78ff46059cb0e863a99c25e4ff85d95edf200fc0bbf9b17bdaf0cc1e14`), with the new wheel SHA and exact source root. It exited 0 and produced inventory SHA256 `1f108531d72e785508fe2361c6654a961df4fbc40a4ba4a02308b2593ab35bba`: Linux target graph 101 snapshot crates plus two own crates, 103 PERMISSIVE / HOLD 0, no completeness gaps. NumPy 2.5.2 remains a separate Python HOLD. This receipt applies to `70e3466c`; any subsequent head needs its own exact-head artifact check.
