...
- reasoning-effort allocation by role/stage;
...
- verifier/auditor: independent evidence-focused reasoning;
...
Nielsen, S., Cetin, E., Schwendeman, P., Sun, Q., Xu, J., & Tang, Y. (2026). *Learning to orchestrate agents in natural language with the Conductor*. International Conference on Learning Representations. arXiv:2512.04388. https://arxiv.org/abs/2512.04388

Sakana AI. (2026, April 24). *Sakana Fugu: A multi-agent orchestration system as a foundation model*. https://sakana.ai/fugu-beta/

Tran, D., & Kiela, D. (2026). *Single-agent LLMs outperform multi-agent systems on multi-hop reasoning under equal thinking token budgets*. arXiv:2604.02460. https://arxiv.org/abs/2604.02460
...
Xu, J., Sun, Q., Schwendeman, P., Nielsen, S., Cetin, E., & Tang, Y. (2026). *TRINITY: An evolved LLM coordinator*. International Conference on Learning Representations. arXiv:2512.04695. https://arxiv.org/abs/2512.04695
