...
| --- | --- | --- | --- | ---: | --- |
| [`Chalmers_2012_mirt_JSS.pdf`](Chalmers_2012_mirt_JSS.pdf) | [JSS article](https://www.jstatsoft.org/article/view/v048i06), [PDF](https://www.jstatsoft.org/article/download/v048i06/598) | Article page states CC BY | — | 641,909 | `e1db8d9b520078add9df0d9f714120bb242a56eac71e2906d359537e649fa8b2` |
...
- Mislevy (1985), [ETS report RR-85-33](https://www.ets.org/research/policy_research_reports/publications/report/1985/ihph.html), [full text](https://files.eric.ed.gov/fulltext/ED268138.pdf): the readable report states all rights reserved, so its p. 13 MAP/EM locator is cited without redistributing the PDF.
