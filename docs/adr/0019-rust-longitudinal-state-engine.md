# ADR-0019: Rust-owned longitudinal state layer
...
and ADR-0016 (Figma buyer-evidence design boundary). PR #948 independently
records Bradley–Terry Hunter MM as ADR-0017 and Angoff delta-plot as
ADR-0018. This decision therefore uses ADR-0019 so the longitudinal state
layer does not collide with those citation records.
