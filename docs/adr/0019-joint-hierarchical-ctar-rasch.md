# ADR-0019: Joint MAP hierarchical continuous-time AR(1) Rasch slice
...
ADR-0018 on the live longitudinal state-engine branch (`#976`) owns an
...
### Relabel the ADR-0018 OLS/AR kernels as random effects
