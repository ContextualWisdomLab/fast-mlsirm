...
| [0021](0021-tepp-anchored-topic-importance.md) | Accepted | TEPP supplies posterior plausible values; the exact Rust case-deletion context-influence estimator remains fail-closed until recovery and real CPU/GPU parity. |
