...
| [0027](0027-rust-registry-distribution-boundary.md) | Proposed | Keep `mlsirm-core` inside the `fast-mlsirm` Maturin/PyPI product boundary; crates.io publication requires a successor ADR and independent release contract. |
