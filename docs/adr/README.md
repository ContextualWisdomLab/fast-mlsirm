...
| [0022](0022-tepp-topic-context-influence-boundary.md) | Proposed | The unmerged integration adapter admits TEPP posterior topic evidence without coupling `mlsirm-core` to TEPP; case-deletion influence stays fail-closed until recovery and CPU/GPU parity. |
