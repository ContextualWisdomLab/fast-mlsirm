...
| Finite-population proportion inference | PRD-FR-045, NFR-008 | ADR-0022, ADR-0023 | Rust sampling design and achieved SRSWOR estimator/variance/exact interval, PyO3/Python contracts, exhaustive coverage and published-table tests, doctoring evidence | Proposed |
