...
| TEPP posterior topic-context influence | PRD-FR-063, TRD-MLT | ADR-0022 | `mlsirm_core::topic_context_influence` validates the exact posterior, Event Lineage, temporal provenance, and BU/PU/team/person membership contract; estimation returns `EstimatorUnavailable` | Proposed / fail-closed prerequisite |
