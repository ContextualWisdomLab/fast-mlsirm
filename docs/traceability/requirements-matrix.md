...
| Multilevel/multiple-membership/temporal | PRD-FR-060..062, TRD-MLT | ADR-0007 | protected main has contextual/multilevel contracts; this active PR adds Rust MAP recovery of crossed / multiple-membership `u_h`, while OLS/AR and continuous-time claims remain separate slices | Proposed/partial / active PR |
