...
| Multilevel/multiple-membership/temporal | PRD-FR-060..062, TRD-MLT | ADR-0007 | contracts plus Rust MAP recovery of crossed / multiple-membership `u_h`; OLS/AR and continuous-time claims remain separate slices | Partial / estimator evidence for `u_h` |
