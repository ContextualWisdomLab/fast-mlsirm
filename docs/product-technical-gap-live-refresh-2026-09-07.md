...
| CodeQL rerun recovery, live-base liveness, exact-run settlement, and receipt identity | `ContextualWisdomLab/.github#1902` exact head `e07e8fd50378ed0d73fa33bacb7a647f832cd578`, tree `7e55de0ef9f8df78e5eb18c98019afa044f5bd68`, protected base `main@7fd571dbcdbae6acf29d8f4ee704d7ba6297e4db`, twelve CodeQL-owner paths | Rebind queued runs to the freshly validated live base SHA while preserving exact head/repository/base-ref identity; authenticate every App or narrow self-repository receipt candidate and require one unique evidence-complete run/state; retain immutable producer-source ancestry, complete failed-job settlement identity, native pagination, least privilege, SARIF provenance, and exact required-run binding | **Source repaired and Ready for review admission; hosted gates pending.** RED reproduced stale-event/live-base deadlock plus conflicting complete receipts in shard and coordinator. GREEN: two-workflow contracts 104 passed; repository 3,054 passed / 1 skipped / 21 subtests; statement/branch and public-doc coverage 100%; Python compile and diff check clean. Protected-base comparison is 48 ahead / 0 behind, mergeable, and repaired review threads are resolved. Ready was restored on the unchanged head at `2026-09-08T07:07:41Z`; CodeQL PR `34197820399`, Python Security `34197820352`, Security Scan `34197820342`, and Semgrep `34197820370` are queued, while Agent Review Runtime `34197697829` is pending. Ready is not approval or merge authority; local actionlint is unavailable. Evidence: `.github#1902` comments `5580795529` and `5580810425`. |
...
1. Let `.github#1902@e07e8fd5` prove its exact required-run-bound receipt or direct-evidence path in
...
2. Let `.github#1902@e07e8fd5` and stacked `.github#1999@64d19495` acquire
