...
| CodeQL rerun recovery, live-base liveness, exact-run settlement, and receipt identity | `ContextualWisdomLab/.github#1902` exact head `87228f918ff17cd1e7216ed8d5a37bd1de4d93db`, tree `2e80fd0474632ff52a3813c21503f2e95e5a5785`, protected base `main@7fd571dbcdbae6acf29d8f4ee704d7ba6297e4db`, twelve CodeQL-owner paths | Capture one validated live base before matrix expansion and retain it across every shard/coordinator in the attempt; reject a later base advance; re-authenticate predecessor receipts before combining them with current direct evidence; retain immutable producer-source ancestry, complete failed-job settlement identity, native pagination, least privilege, SARIF provenance, and exact required-run binding | **Source repaired and Ready for review admission; hosted gates pending.** Concurrent head `855f0173…` and repair `2b60f0ef…` were preserved in an ordinary two-parent non-force reconciliation. RED reproduced mixed-base sibling admission and predecessor-receipt settlement failure. GREEN: two-workflow contracts 118 passed; repository 3,068 passed / 1 skipped / 21 subtests; statement coverage `13,194/13,194`, branch coverage `5,330/5,330`, and public-doc coverage 100%; Python compile and diff check clean. Protected-base comparison is 53 ahead / 0 behind, mergeable, with zero unresolved threads. Ready was restored on the unchanged head at `2026-09-08T08:18:29Z`; CodeQL PR `34203791363` is pending and Python Security `34203791227`, Security Scan `34203791206`, and Semgrep `34203791274` are queued. Ready is not approval or merge authority; local actionlint is unavailable. Evidence: `.github#1902` comment `5581665227`. |
...
1. Let `.github#1902@87228f91` prove its exact required-run-bound receipt or direct-evidence path in
...
2. Let `.github#1902@87228f91` and stacked `.github#1999@64d19495` acquire
