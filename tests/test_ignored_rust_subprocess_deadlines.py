"""Integration contracts for ignored Rust operation-specific deadlines."""
...
def test_runner_routes_metadata_inventory_and_study_through_distinct_operations(
    monkeypatch,
) -> None:
    """Each subprocess class uses the deadline policy matching its duration."""
...
def test_inventory_uses_capture_and_check_with_bounded_list_operation(monkeypatch) -> None:
    """Discovery retains exact stdout parsing and fail-fast exit semantics."""
