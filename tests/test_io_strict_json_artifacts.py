...
def test_simulation_rejects_nonfinite_config_before_replacing_json_artifacts(
    ...
    # Manifest fields sourced from the config cannot independently receive a
    # non-finite value after config serialization has already passed. Prove the
    # public writer leaves an existing manifest untouched on this earlier gate.
