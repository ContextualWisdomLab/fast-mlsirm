...
def test_engine_kind_preserves_builtin_string_and_member_forms() -> None:
    ...
    assert automated_engine(engine_kind="automated_engine").engine_kind is EngineKind.AUTOMATED
    assert automated_engine(engine_kind=EngineKind.AUTOMATED).engine_kind is EngineKind.AUTOMATED
