...
def test_correlated_mirt_recovery_has_dedicated_bounded_evidence_job() -> None:
    ...
    corr_mirt = _job_block(workflow, "corr-mirt-recovery", "qmc-mirt-d4-normal-recovery")
...
def test_qmc_mirt_recovery_cells_have_independent_bounded_evidence_jobs() -> None:
    """Each 500-rep QMC-MIRT cell must own a wall clock rather than share six hours."""
