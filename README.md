...
sections that are absent in the source JSON are summarized in a diagnostics
coverage block instead of rendering as repeated blank-looking report sections.
