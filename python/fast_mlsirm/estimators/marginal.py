...
def _item_q(
    ...
    """
    # Optimized: r * _log_sigmoid(eta) + (n - r) * _log_sigmoid(-eta) simplifies to r * eta + n * _log_sigmoid(-eta)
        ...
        if uses_space and anchor_tau is None and _interaction_kind(model) == "distance":
            ...
            if info > 0.0:
                ...
                def total_q(tau_c: float) -> float:
                    ...
                    # Optimized: r * _log_sigmoid(e) + (n - r) * _log_sigmoid(-e) simplifies to r * e + n * _log_sigmoid(-e)
