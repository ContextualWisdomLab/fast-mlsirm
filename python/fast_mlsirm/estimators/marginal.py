            ...
            for _ in range(m_steps):
                ...
                if uses_space:
                    if kind_i == "inner":
                        ...
                        # Optimized: replace np.sum(diff * diff, axis=1) with np.einsum('ij,ij->i', diff, diff) to avoid unnecessary intermediate 2D array allocations and improve performance
