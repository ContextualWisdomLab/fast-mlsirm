...
def _person_logliks(
    ...
    Returns (l_ll, log_zdx, log_lp): l has shape (P, D, Qt, Nx); log_zdx (P, D, Nx);
    log_lp (P,).
    """
            ...
            for _ in range(m_steps):
                ...
                if uses_space:
                    if kind_i == "inner":
                        ...
                        # Optimized: replace np.sum(A * B, axis=1) with np.einsum to avoid intermediate array allocation
