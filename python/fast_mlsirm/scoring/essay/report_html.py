...
def _content_security_policy() -> str:
    """Authorize only the exact package-owned stylesheet in the standalone artifact."""
    css_digest = hashlib.sha256(_css().encode("utf-8")).digest()
    css_hash = base64.b64encode(css_digest).decode("ascii")
    return "; ".join(
        (
            "default-src 'none'",
...
def _css() -> str:
    ...
    return """
:root { color-scheme: light dark; font-family: system-ui, sans-serif; --review-required: #9c2f1f; --review-clear: #357a38; --muted: #60656f; --line: #767676; }
...
@media print {
  :root { --review-required: #9c2f1f; --review-clear: #357a38; --muted: #60656f; --line: #767676; }
