"""Inert integer normalization for enterprise evidence contracts.

Enterprise evidence counts and offsets accept Python and NumPy integer scalars.
This composition helper establishes an exact package-trusted scalar identity
before normalization so caller-defined conversion protocols or numeric
...
def install(contracts_module: ModuleType) -> None:
    """Install inert integer normalization on package-owned enterprise contracts."""
