...
def neg_loglik_and_grad(
    ...
    if free_alpha:
        # Optimized gradient computation: avoid O(N*J) 2D array allocation for theta[:, factors]
        # and replace element-wise multiplication/summation with O(J*D) BLAS matrix multiplication
