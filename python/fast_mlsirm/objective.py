...
def neg_loglik_and_grad(
    ...
    if free_alpha:
        # Optimized gradient computation: replace element-wise multiplication and sum with BLAS matrix multiplication
        # Avoids O(NxJ) intermediate array allocation and improves cache locality
