...
def neg_loglik_and_grad(
    ...
    if free_alpha:
        # Optimized gradient computation: avoid large intermediate array allocations during summation
        # over factor slices by replacing them with transposed matrix multiplication and index selection.
