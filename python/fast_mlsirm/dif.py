...
for _old_name, _new_name in (
    ...
    _old_fn = globals()[_old_name]  # nosemgrep: python.lang.security.dangerous-globals-use.dangerous-globals-use
    _new_fn = globals()[_new_name]  # nosemgrep: python.lang.security.dangerous-globals-use.dangerous-globals-use
