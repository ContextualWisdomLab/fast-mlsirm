...
mantel_haenszel_dif.__doc__ = (
    f"{mantel_haenszel_dif.__doc__}\n\n{detect_dif_mantel_haenszel.__doc__}"
)
mantel_haenszel_dif_purified.__doc__ = f"{mantel_haenszel_dif_purified.__doc__}\n\n{detect_dif_mantel_haenszel_purified.__doc__}"
logistic_dif_purified.__doc__ = (
    f"{logistic_dif_purified.__doc__}\n\n{detect_dif_logistic_purified.__doc__}"
)
logistic_dif.__doc__ = f"{logistic_dif.__doc__}\n\n{detect_dif_logistic.__doc__}"
mantel_smd_dif.__doc__ = f"{mantel_smd_dif.__doc__}\n\n{detect_dif_mantel_smd.__doc__}"
gmh_dif.__doc__ = f"{gmh_dif.__doc__}\n\n{detect_dif_gmh.__doc__}"
breslow_day_dif.__doc__ = (
    f"{breslow_day_dif.__doc__}\n\n{detect_dif_breslow_day.__doc__}"
)
