...
from ._classification_cutscore_safety import (
    install as _install_classification_cutscore_safety,
)
...
_install_classification_cutscore_safety(_classification)
...
del (
    _classification,
    _install_classification_cutscore_safety,
