...
from ._polytomous_prediction_safety import install as _install_polytomous_prediction_safety
...
_install_polytomous_prediction_safety(_polytomous)
...
del (
    ...
    _install_polytomous_prediction_safety,
