// Auto-generated probabilists' Gauss-Hermite tables (weights normalized to sum 1).
// Source: numpy.polynomial.hermite_e.hermegauss(Q); shortest-roundtrip f64 repr —
// bit-identical to the NumPy reference (parity contract, same convention as mmle.rs).
pub(crate) const GH_NODES_7: [f64; 7] = [
    -3.7504397177257425,
    -2.366759410734541,
    -1.1544053947399682,
    0.0,
...
pub(crate) const GH_WEIGHTS_7: [f64; 7] = [
...
pub(crate) const GH_NODES_11: [f64; 11] = [
    -5.1880012243748705,
    -3.936166607129977,
    -2.865123160643645,
    -1.876035020154846,
...
pub(crate) const GH_WEIGHTS_11: [f64; 11] = [
    8.121849790214909e-07,
    0.0001956719302712236,
    0.0067202852355372706,
    0.06613874607105778,
    0.24224029987396997,
    0.3694083694083693,
    0.24224029987396997,
...
pub(crate) const GH_NODES_15: [f64; 15] = [
    -6.363947888829839,
    -5.190093591304781,
    -4.1962077112690155,
    -3.2890824243987664,
...
pub(crate) const GH_WEIGHTS_15: [f64; 15] = [
    8.589649899633252e-10,
    5.975419597920599e-07,
    5.642146405189029e-05,
    0.001567357503549956,
    0.017365774492137616,
    0.08941779539984437,
    0.23246229360973225,
    0.31825951825951815,
    0.23246229360973225,
...
pub(crate) const GH_NODES_21: [f64; 21] = [
    -7.8493828951138225,
    -6.751444718717461,
    -5.8293820073044715,
    -4.994963944782025,
...
pub(crate) const GH_WEIGHTS_21: [f64; 21] = [
    2.0989912195656712e-14,
    4.9753686041217186e-11,
    1.4506612844930857e-08,
    1.2253548361482526e-06,
    4.219234742551663e-05,
    0.0007080477954815369,
    0.006439697051408777,
    0.033952729786542866,
    0.10839228562641949,
    0.2153337156950597,
    0.27026018357287707,
    0.2153337156950597,
...
pub(crate) const GH_NODES_31: [f64; 31] = [
    -9.893385708986651,
    -8.87430140948879,
    -8.024193227361646,
    -7.2600004888908645,
...
pub(crate) const GH_WEIGHTS_31: [f64; 31] = [
    2.6059738548929907e-22,
    2.883352367857825e-18,
    3.3284683241484216e-15,
    1.049603362311366e-12,
    1.3272514835897158e-10,
    8.243931619119728e-09,
    2.8456100881628386e-07,
    5.9232023176863475e-06,
    7.871624069602279e-05,
    0.0006960312713792916,
    0.004221717767270714,
    0.017967875843441658,
    0.054567258894475015,
    0.1196831096958546,
    0.19113200477464318,
    0.2232941387424068,
    0.19113200477464318,
...
pub(crate) const GH_NODES_41: [f64; 41] = [
    -11.614937254337464,
    -10.647536786319334,
    -9.843433249157995,
    -9.123069907984473,
...
pub(crate) const GH_WEIGHTS_41: [f64; 41] = [
    ...
    1.994794756757345e-09,
    4.66734770810732e-08,
    7.658186077982326e-07,
    9.058608622432971e-06,
    7.89471931950462e-05,
...
pub(crate) const GH_NODES_81: [f64; 81] = [
    -16.925476835034505,
    -16.070115288084143,
    -15.363360220077677,
    -14.73368054299171,
...
pub(crate) const GH_WEIGHTS_81: [f64; 81] = [
    2.452805513897977e-63,
    2.5392599790110647e-57,
    1.4715361059410395e-52,
    1.744647127841303e-48,
    7.053012730963142e-45,
    1.2721951837934705e-41,
    1.2063175236617348e-38,
    6.709037503900243e-36,
    2.3656319313870077e-33,
    5.603354872334599e-31,
    9.321663479938348e-29,
    1.1281327190756607e-26,
    1.0218473057257003e-24,
    7.091077025468037e-23,
    3.844131066500376e-21,
    1.6549612938551538e-19,
    5.738221937832045e-18,
    1.621866631538272e-16,
    3.776192496008265e-15,
    7.309191273945898e-14,
    1.1856329334260767e-12,
    1.6232084074369437e-11,
    1.8874073283497914e-10,
    1.8743179035614513e-09,
    1.5975703422328164e-08,
    1.1739104500747906e-07,
    7.46587063036017e-7,
    4.1240539582658024e-06,
    1.9848557310766824e-05,
    8.346549703701785e-5,
    0.00030742200906347524,
    0.0009939500003995178,
    0.0028263907639617886,
    0.007080556157068602,
    0.01564945581278497,
    0.030553610014116196,
    0.05274754103184778,
    0.08058930011035416,
    0.10903458212018821,
    0.130694874885398,
...
static GH_121: OnceLock<(Vec<f64>, Vec<f64>)> = OnceLock::new();

fn gh_rule_121() -> (&'static [f64], &'static [f64]) {
    let (nodes, weights) = GH_121.get_or_init(|| {
        // Generated from numpy.polynomial.hermite_e.hermegauss(121) with
        // numpy 2.5.3, weights normalized to sum 1 (same provenance as the
        // 61-point rule above). Study-floor rule for unidimensional
        // fixed-item calibration: FIPC recovery tests run q_theta = 121.
        let positive = [
            0.0,
            0.28501780679310007,
            0.5700832745530116,
        ...
        let positive_weights = [
            ...
            0.04121822001548218,
            0.02635115514497509,
            0.015519421559108224,
            0.008417056636151726,
            0.004202149969799203,
            0.001930193224522068,
            0.0008152900490257233,
            0.00031647664382453155,
            0.00011282262945797822,
            3.691069858144618e-05,
            1.1072724967321525e-05,
            3.043087064561213e-06,
            7.654349263188937e-07,
            1.7602554448172662e-07,
            3.696724344268887e-08,
            7.080947052923608e-09,
            1.2354163481713077e-09,
            1.9604271853658719e-10,
            2.8250140207431762e-11,
            3.690505668951348e-12,
            4.3626549047807794e-13,
            4.6575401266576323e-14,
            4.48100557161567e-15,
            3.8761904920015805e-16,
            3.0071939671679786e-17,
            2.0867523204166246e-18,
            1.291401970468699e-19,
            7.104806088944169e-21,
            3.462914919404132e-22,
            1.4896851890040506e-23,
            5.632800520870026e-25,
            1.8637035086669462e-26,
            5.369164880856069e-28,
            1.339531046108248e-29,
            2.876780869479805e-31,
            5.2829571114916795e-33,
            8.234633993360254e-35,
            1.0804567548306873e-36,
            1.1822719046940636e-38,
            1.067566493107084e-40,
            7.860077957050506e-43,
            4.654081486111002e-45,
            2.18122576256244e-47,
            7.942370823899585e-50,
            2.198085375537124e-52,
            4.503734268433906e-55,
            6.617176305951275e-58,
            6.701853420038019e-61,
            4.450903528030656e-64,
            1.8164972140199824e-67,
            4.174469997354156e-71,
            4.776161920352659e-75,
            2.2619057832768103e-79,
            3.27331217516094e-84,
            8.117885574707396e-90,
            7.89936117942228e-97,
        ];
...
static GH_81: OnceLock<(Vec<f64>, Vec<f64>)> = OnceLock::new();

fn gh_rule_81() -> (&'static [f64], &'static [f64]) {
    let (nodes, weights) = GH_81.get_or_init(|| (GH_NODES_81.to_vec(), GH_WEIGHTS_81.to_vec()));
    (nodes, weights)
}
...
pub(crate) fn require_gh_rule_unidim(
    ...
    resolve_gh_rule_unidim(q).map_err(|e| format!("{name} {q}: {e}"))
}
